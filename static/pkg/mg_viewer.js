...
export function get_parse(sentence, grammar, target_category, min_log_prob, max_steps, max_beams) {
    ...
    const ptr2 = passStringToWasm0(target_category, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len2 = WASM_VECTOR_LEN;
    const ret = wasm.get_parse(ptr0, len0, ptr1, len1, ptr2, len2, min_log_prob, max_steps, max_beams);
    return ret;
}
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('mg_viewer_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
